...
public abstract class EaseChatRow extends LinearLayout {
    ...
    private void setUpBaseView() {
        ...
        if(userAvatarView != null) {
            ...
            String avatar = EaseUserUtils.curAvatar;
            String nickName = EaseUserUtils.curNickName;
            if (message.direct() == Direct.SEND) {
            } else {
                avatar = (String) message.ext().get("avatar");
                nickName = (String) message.ext().get("nick");
            }

            if(message.getUserName().equals("admin")){
                userAvatarView.setImageResource(R.drawable.icon_bell);
                return;
            }

            if(avatar != null){
                EaseUserUtils.setUserAvatar(context, userAvatarView, avatar);
            }

            if (nickName != null){
                EaseUserUtils.setUserNick(usernickView, nickName);
            }
        }
