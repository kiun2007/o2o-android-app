    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (conversation.getType() == EMConversationType.GroupChat) {
            ...
            if (username.equals("admin")) {
                ...
                holder.avatar.setImageResource(R.drawable.icon_bell);
                EaseUserUtils.setUserNick("系统消息", holder.name);
            } else {
                if(heAvatar != null){
                    EaseUserUtils.setUserAvatar(getContext(), holder.avatar, heAvatar);
                }
                if(heNickName != null){
                    EaseUserUtils.setUserNick(holder.name, heNickName);
                }
            }
            holder.motioned.setVisibility(View.GONE);
        }
