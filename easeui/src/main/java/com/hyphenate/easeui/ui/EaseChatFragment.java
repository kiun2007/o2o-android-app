...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    protected String meAvatar;
    protected String meNickName;
    protected String heAvatar;
    protected String heNickName;
    ...
    public static final int ITEM_VOICE = 4;

//    protected int[] itemStrings = {R.string.attach_take_pic, R.string.attach_picture, R.string.attach_location, R.string.attach_location};
    protected int[] itemStrings = {R.string.attach_take_pic, R.string.attach_picture};
    protected int[] itemdrawables = {R.drawable.ease_chat_takepic_selector, R.drawable.ease_chat_image_selector};
//    protected int[] itemdrawables = {R.drawable.ease_chat_takepic_selector, R.drawable.ease_chat_image_selector,
//            R.drawable.ease_chat_location_selector, R.drawable.ease_icon_phone};
    protected int[] itemIds = {ITEM_TAKE_PICTURE, ITEM_PICTURE};
//    protected int[] itemIds = {ITEM_TAKE_PICTURE, ITEM_PICTURE, ITEM_VIDEO, ITEM_VOICE};
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        heAvatar = fragmentArgs.getString(EaseConstant.EXTRA_HE_AVATAR);
        meAvatar = fragmentArgs.getString(EaseConstant.EXTRA_AVATAR);
        heNickName = fragmentArgs.getString(EaseConstant.EXTRA_HE_NICK_NAME);
        meNickName = fragmentArgs.getString(EaseConstant.EXTRA_NICK_NAME);

        EaseUserUtils.curAvatar = meAvatar;
        EaseUserUtils.curNickName = meNickName;
    ...
    protected void initView() {
        ...
        EasePermissionUtils.getInstance(new EasePermissionUtils.PermissionGrant() {
            @Override
            public void onPermissionGranted(Object permissionName, boolean isSuccess) {
                switch (String.valueOf(permissionName)) {
                    ...
                    case Manifest.permission.READ_SMS:
                        break;
                    case EasePermissionUtils.REQUEST_MULTIPLE_PERMISSION:
                        break;
                    default:
                        break;
                }
            }
        }).requestPermission(getActivity(), REQUEST_PERMISSIONS);
        ...
        try {
            String name = getArguments().getString("hxAccount");
            if (!name.equals("admin")) {
                //                listView.addHeaderView(initOrderHeader());
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    protected void setUpView() {
        ...
        if (toChatUsername.equals("admin")) {
            ...
            if (heNickName != null) {
                String[] nickNames = heNickName.split("\\|");
                if (nickNames.length > 0) {
                    titleBar.setTitle(nickNames[0]);
                }
            }
        }
    ...
    protected void onConversationInit() {
        ...
        if (heNickName != null && heAvatar != null) {
            conversation.setExtField("{\"avatar\":\"" + heAvatar + "\",\"nick\":\"" + heNickName + "\"}");
        }
    ...
    protected Intent getMapIntent() {
        return new Intent(getActivity(), EaseBaiduMapActivity.class);
    }
            ...
            switch (itemId) {
                case ITEM_TAKE_PICTURE:
                    ...
                    EasePermissionUtils.getInstance(new EasePermissionUtils.PermissionGrant() {
                        ...
                        public void onPermissionGranted(Object permissionName, boolean isSuccess) {
                            if (isSuccess) {
                                Log.i("123456", permissionName + "........." + true);
                            } else {
                                Log.i("123456", permissionName + "........." + false);
                            }
                            switch (String.valueOf(permissionName)) {
                                case EasePermissionUtils.REQUEST_MULTIPLE_PERMISSION:
                                    if (isSuccess) {
                                        ...
                                        Toast.makeText(getActivity(), "请开启权限后，重试", Toast.LENGTH_SHORT).show();
                                    }
                                    break;
                                default:
                                    break;
                ...
                case ITEM_PICTURE:
                    EasePermissionUtils.getInstance(new EasePermissionUtils.PermissionGrant() {
                        @Override
                        public void onPermissionGranted(Object permissionName, boolean isSuccess) {
                            Log.i("123456", permissionName + "........." + isSuccess);
                            if (String.valueOf(permissionName).equals(Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                                if (isSuccess) {
                                    selectPicFromLocal();
                                } else {
                                    Toast.makeText(getActivity(), "请开启权限后，重试", Toast.LENGTH_SHORT).show();
                    ...
                    }).requestPermission(getActivity(), Manifest.permission.WRITE_EXTERNAL_STORAGE);
                    break;
                case ITEM_VIDEO:
    ...
    protected void sendMessage(EMMessage message) {
        ...
        if (meAvatar != null) {
            message.setAttribute("avatar", meAvatar);
        }
        if (meNickName != null) {
            message.setAttribute("nick", meNickName);
        }
    ...
    protected void selectPicFromCamera() {
        ...
        String PATH_BASE = Environment.getExternalStorageDirectory().getAbsolutePath() + "/" + "xzxx" + "/";
        try {
            new File(PATH_BASE).mkdirs();
            new File(PATH_BASE + "/.nomedia").createNewFile();
        } catch (IOException e) {
            //e.printStackTrace();
        }
        cameraFile = new File(PATH_BASE, EMClient.getInstance().getCurrentUser()
                + System.currentTimeMillis() + ".jpg");
