...
public class MHorProgressBar extends View {
    ...
    public void setDurProgress(int dur, ImageView imageView, TextView textView) {
        if (dur <= 50) {
            imageView.setImageDrawable(getResources().getDrawable(R.drawable.icon_bad));
            textView.setTextColor(Color.rgb(255,103,102));
        } else if (dur > 50 && dur <= 90) {
            imageView.setImageDrawable(getResources().getDrawable(R.drawable.icon_well));
            textView.setTextColor(Color.rgb(255,130,28));
        } else if (dur > 90) {
            imageView.setImageDrawable(getResources().getDrawable(R.drawable.icon_excellent));
            textView.setTextColor(Color.rgb(53,177,241));
        }
        if (dur < 0) {
            dur = 0;
