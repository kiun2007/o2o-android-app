...
public class AddressPickerView extends RelativeLayout implements View.OnClickListener {
    ...
    private boolean showDistrict = true;  //是否显示区
    ...
    public AddressPickerView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.AddressPicker);
        showDistrict =array.getBoolean(R.styleable.AddressPicker_showDistrict, true);
        array.recycle();
        init(context);
    }
    ...
    private void initData() {
        ...
        // 将数据转换为对象
        mAddressBean = new Gson().fromJson(jsonSB.toString(), AddressBean.class);
                    ...
                    switch (tabSelectPosition) {
                        ...
                        case 1:
                            ...
                            if(showDistrict) {
                                ...
                                mTvSure.setTextColor(defaultSureUnClickColor); // 灰掉确定按钮
                            } else {
