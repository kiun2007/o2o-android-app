...
//        borderColor = arr.getColor(R.styleable.SimpleRatingBar_srb_borderColor, getResources().getColor(R.color.golden_stars));
        ...
        starsSeparation = arr.getDimensionPixelSize(R.styleable.SimpleRatingBar_srb_starsSeparation, (int) valueToPixels(4, "DP"));
        ...
        starBorderWidth = arr.getFloat(R.styleable.SimpleRatingBar_srb_starBorderWidth, 0f);
  ...
  /* ----------- GETTERS AND SETTERS ----------- */
     ...
     * @param dimen
     */
    public float getMaxStarSize(String dimen) {
     ...
     * @param maxStarSize
     */
    public void setMaxStarSize(float maxStarSize, String dimen) {
     ...
     * @param dimen
     */
    public float getStarSize(String dimen) {
     ...
     * @param dimen
     */
    public void setStarSize(float starSize, String dimen) {
     ...
     * @param dimen
     */
    public float getStarsSeparation(String dimen) {
     ...
     * @param starsSeparation
     */
    public void setStarsSeparation(float starsSeparation, String dimen) {
     ...
     * @param dimen
     */
    public float getStarBorderWidth(String dimen) {
     ...
     * @param dimen
     */
    public void setStarBorderWidth(float starBorderWidth, String dimen) {
     ...
     * @param dimen
     */
    public float getStarCornerRadius(String dimen) {
     ...
     * @param dimen
     */
    public void setStarCornerRadius(float starCornerRadius, String dimen) {
     ...
     * @param dimen
     */
    private float valueToPixels(float value, String dimen) {
        switch (dimen) {
            case "DP":
     ...
     * @param dimen
     */
    private float valueFromPixels(float value, String dimen) {
        switch (dimen) {
            case "DP":
    ...
    public class AnimationBuilder {
         ...
         *
         * @param repeatCount
         *         must be a positive value or ValueAnimator.INFINITE
         */
         ...
         *
         * @param repeatMode
         *         must be ValueAnimator.RESTART or ValueAnimator.REVERSE
         */
