...
public class StarBar extends View implements DriveListener {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        dataPath = mTypedArray.getString(R.styleable.RatingBar_dataPath);
        mTypedArray.recycle();
    ...
    public void fill(Object data) {
        ...
        if (data != null) {
            ...
            if (data instanceof String) {
                startNumber = Float.parseFloat(data.toString());
            }

            if (data instanceof Number) {
                startNumber = ((Number) data).floatValue();
            }
            setStarMark(startNumber);
        }
    }
    ...
    public KeyValue getParam() {
        if (dataPath != null) {
            int value = (int) starMark;
            return new KeyValue(dataPath, value);
        }
        return null;
    }
