...
public class SpiderWebScoreView extends View {
    ...
    private int hierarchyCount = 4;  // 整个蛛网分多少层（例如最大分数是10分，分5层，那么每层就代表2分）
    ...
    private void drawHierarchyByRadius(Canvas canvas, float currentRadius) {
        ...
        float offsetAngle = averageAngle > 0 && angleCount % 2 == 0 ? averageAngle : 0;
