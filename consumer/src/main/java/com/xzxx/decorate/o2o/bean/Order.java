...
public class Order {
    ...
    public float getMaster_star_level() {
        return master_star_level;
    }

    public void setMaster_star_level(float master_star_level) {
        this.master_star_level = master_star_level;
    }
}
