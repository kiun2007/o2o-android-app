...
public class FlowLayout extends ViewGroup {
    ...
    public FlowLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        lineSpacing = mTypedArray.getDimensionPixelOffset(
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        int mPaddingLeft = getPaddingLeft();
        int mPaddingRight = getPaddingRight();int mPaddingTop = getPaddingTop();
        ...
        for (int i = 0; i < this.getChildCount(); i++) {
            ...
            Log.e("FlowLayout","lineUsed + spaceWidth " + lineUsed + spaceWidth + " >>lineWidth " + lineWidth);
            if (lineUsed + spaceWidth > lineWidth) {
                //approach the limit of width and move to next line
                Log.e("FlowLayout","move to next line");
