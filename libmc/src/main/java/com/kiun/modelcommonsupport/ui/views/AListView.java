 ...
 * 超级列表, 可以设置简单的适配器功能.
 */
public class AListView extends ListView implements DriveListener, MCUIResponse, XRefreshView.XRefreshViewListener, Refresher {

    private static final String Tag = AListView.class.getSimpleName();
    ...
    private MCListRequest listRequest;
    ...
    public void onRefresh() {
        if(!NetWorkUtil.isNetworkAvailable()){
            ToastUtil.showToast(getContext(),"网络不可用，请检查您的网络");
            mXRefreshView.stopRefresh();
            return;
        }
