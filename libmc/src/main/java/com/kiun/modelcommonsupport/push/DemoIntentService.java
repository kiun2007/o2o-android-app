package com.kiun.modelcommonsupport.push;
...
public class DemoIntentService extends GTIntentService {
    ...
    public void onReceiveMessageData(Context context, GTTransmitMessage msg) {
        // consumer appid==mzEBASs4zK68z1eaFPzKJ4
        // master  appid==mzEBASs4zK68z1eaFPzKJ4
        ...
        if (payload == null) {
            ...
            if (data.equals("1")) {// 刷新首页列表
                Intent intent = new Intent();
                intent.setAction("refresh_home_fragment_list");
                sendBroadcast(intent);
            } else if (data.equals("2")) {// 抢登
                //                try {
                ...
                //                }
                //                Intent intent = new Intent();
                //                intent.setAction("login_in_other_phone");
                //                sendBroadcast(intent);
                sendMessage(data, 0);
            }
            // 测试消息为了观察数据变化
    ...
    public void onReceiveOnlineState(Context context, boolean online) {
        ...
        Log.e(TAG, "onReceiveOnlineState -> " + "clientid = " + cid);
    ...
    public void onNotificationMessageArrived(Context context, GTNotificationMessage message) {
        Intent intent = new Intent();
        intent.setAction("refresh_home_red");
        sendBroadcast(intent);
        Log.i(TAG, "onNotificationMessageArrived -> " + "appid = " + message.getAppid() + "\ntaskid = " + message.getTaskId() + "\nmessageid = "
    ...
    public void onNotificationMessageClicked(Context context, GTNotificationMessage message) {
        ...
        if (userInfo != null) {
            IntentUtil.gotoActivity(MainApplication.getInstance(), ContactListActivity.class);
        }
        Log.i(TAG, "onNotificationMessageClicked -> " + "appid = " + message.getAppid() + "\ntaskid = " + message.getTaskId() + "\nmessageid = "
                + message.getMessageId() + "\npkg = " + message.getPkgName() + "\ncid = " + message.getClientId() + "\ntitle = "
                + message.getTitle() + "\ncontent = " + message.getContent());
    }
    ...
    private void setTagResult(SetTagCmdMessage setTagCmdMsg) {
        ...
        Log.i(TAG, "settag result sn = " + sn + ", code = " + code + ", text = " + getResources().getString(text));
    }
    ...
    private void bindAliasResult(BindAliasCmdMessage bindAliasCmdMessage) {
        ...
        Log.i(TAG, "bindAlias result sn = " + sn + ", code = " + code + ", text = " + getResources().getString(text));
    ...
    private void unbindAliasResult(UnBindAliasCmdMessage unBindAliasCmdMessage) {
        ...
        Log.i(TAG, "unbindAlias result sn = " + sn + ", code = " + code + ", text = " + getResources().getString(text));
    ...
    private void sendMessage(String data, int what) {
        ...
        msg.what = what;
        msg.obj = data;
        MainApplication.sendMessage(msg);
    }
