 ...
 */
public class DatePickerPopWinNew extends PopupWindow implements OnClickListener {
    ...
    public static class Builder {
        ...
        public DatePickerPopWinNew build() {
            if (minYear > maxYear) {
                throw new IllegalArgumentException();
            }
            return new DatePickerPopWinNew(this);
        }
    ...
    public DatePickerPopWinNew(Builder builder) {
