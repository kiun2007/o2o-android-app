package com.kiun.modelcommonsupport.camera;
...
import com.kiun.modelcommonsupport.camera.listener.CaptureListener;
import com.kiun.modelcommonsupport.camera.listener.ClickListener;
import com.kiun.modelcommonsupport.camera.listener.ErrorListener;
import com.kiun.modelcommonsupport.camera.listener.JCameraListener;
import com.kiun.modelcommonsupport.camera.listener.TypeListener;
import com.kiun.modelcommonsupport.camera.state.CameraMachine;
import com.kiun.modelcommonsupport.camera.util.FileUtil;
import com.kiun.modelcommonsupport.camera.util.LogUtil;
import com.kiun.modelcommonsupport.camera.util.ScreenUtils;
import com.kiun.modelcommonsupport.camera.view.CameraView;
 ...
 * =====================================
 */
public class JCameraView extends FrameLayout implements com.kiun.modelcommonsupport.camera.CameraInterface.CameraOpenOverCallback, SurfaceHolder
        .Callback, CameraView {
    ...
    private LinearLayout maskBackView;
    private LinearLayout cameraOptionLayout;
    private TextView bttomTipTextView;
    private TextView rightTipTextView;

    private com.kiun.modelcommonsupport.camera.CaptureLayout mCaptureLayout;
    private com.kiun.modelcommonsupport.camera.FoucsView mFoucsView;
    ...
    private void initView() {
        ...
        maskBackView = view.findViewById(R.id.maskBackView);
        cameraOptionLayout = view.findViewById(R.id.cameraOptionLayout);
        rightTipTextView = view.findViewById(R.id.rightTipTextView);
        bttomTipTextView = view.findViewById(R.id.bttomTipTextView);
        ...
        view.findViewById(R.id.photoButton).setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        mCaptureLayout.setCaptureLisenter(new CaptureListener() {
            ...
            public void takePictures() {
                if(OtherUtils.getInstance().isFastClick(mCaptureLayout))return;
        ...
        imageButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                maskBackView.setVisibility(GONE);
                machine.capture();
            }
        });
        ...
        mCaptureLayout.setTypeLisenter(new TypeListener() {
            ...
            public void cancel() {
                if(viewType == 1){
                    ...
                    maskBackView.setVisibility(VISIBLE);
                }
    ...
    public void setViewType(int type){
        ...
        cameraOptionLayout.setVisibility(viewType == 1 ? GONE : VISIBLE);
        maskBackView.setVisibility(viewType == 1 ? VISIBLE : GONE);
        mCaptureLayout.setVisibility(viewType == 1 ? GONE : VISIBLE);

        rightTipTextView.setVisibility(type == 1 ? VISIBLE : GONE);
        bttomTipTextView.setVisibility(type == 1 ? GONE : VISIBLE);
    }
    ...
    public void onResume() {
        ...
        com.kiun.modelcommonsupport.camera.CameraInterface.getInstance().registerSensorManager(mContext);
    ...
    public void onPause() {
        ...
        com.kiun.modelcommonsupport.camera.CameraInterface.getInstance().isPreview(false);
        com.kiun.modelcommonsupport.camera.CameraInterface.getInstance().unregisterSensorManager(mContext);
    }
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        new Thread() {
            @Override
            public void run() {
                com.kiun.modelcommonsupport.camera.CameraInterface.getInstance().doOpenCamera(JCameraView.this);
            }
        }.start();
    }
    ...
    public void surfaceDestroyed(SurfaceHolder holder) {
        ...
        com.kiun.modelcommonsupport.camera.CameraInterface.getInstance().doDestroyCamera();
    }
...
//                    Log.i("CJT", "result = " + (result - firstTouchLength));
    ...
    public void setSaveVideoPath(String path) {
        com.kiun.modelcommonsupport.camera.CameraInterface.getInstance().setSaveVideoPath(path);
    }
    ...
    public void setErrorLisenter(ErrorListener errorLisenter) {
        ...
        com.kiun.modelcommonsupport.camera.CameraInterface.getInstance().setErrorLinsenter(errorLisenter);
    }
    ...
    public void setMediaQuality(int quality) {
        com.kiun.modelcommonsupport.camera.CameraInterface.getInstance().setMediaQuality(quality);
    }
